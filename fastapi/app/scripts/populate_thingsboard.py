...
def main():
    ...
    devices = {}
    for codigo, info in discovered_stations.items():
        # Normaliza nome: remove espaços e caracteres especiais
        nome_normalizado = info['nome'].replace(' ', '_').replace('-', '_').upper()
        device_name = f"Estacao_{codigo}_{nome_normalizado}"
